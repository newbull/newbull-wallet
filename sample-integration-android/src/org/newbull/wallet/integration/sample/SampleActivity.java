...
package org.newbull.wallet.integration.sample;
...
public class SampleActivity extends Activity {
    ...
    private static final String[] DONATION_ADDRESSES_MAINNET = { "NRAw1VMqxfaY7WZpqqW9g49fB7GHZNLSRs",
            "NccM1vJ7k9WnqZjQt4ua8tHFZrNKSktJeK" };
    ...
    private void handleDonate() {
        ...
        NewBullIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, addresses[0]);
    }
    ...
    private void handleRequest() {
        try {
            ...
            NewBullIntegration.requestForResult(SampleActivity.this, REQUEST_CODE,
    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                final String txHash = NewBullIntegration.transactionHashFromResult(data);
                if (txHash != null) {
                    ...
                    if (NewBullIntegration.paymentFromResult(data) != null)
