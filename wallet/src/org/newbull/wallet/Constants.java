...
public final class Constants {
    ...
    /**
     * The type of NewBull addresses used for the initial wallet: {@link Script.ScriptType#P2PKH} for classic
     * Base58, {@link Script.ScriptType#P2WPKH} for segwit Bech32.
     */
    public static final Script.ScriptType DEFAULT_OUTPUT_SCRIPT_TYPE = Script.ScriptType.P2PKH;//P2WPKH

    /**
     * The type of NewBull addresses to upgrade the current wallet to: {@link Script.ScriptType#P2PKH} for classic
     * Base58, {@link Script.ScriptType#P2WPKH} for segwit Bech32.
     */
    public static final Script.ScriptType UPGRADE_OUTPUT_SCRIPT_TYPE = Script.ScriptType.P2PKH;//P2WPKH
    ...
    public static final boolean ENABLE_EXCHANGE_RATES = false;//true
    ...
    public final static class Files {
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "newbull-wallet-backup" + FILENAME_NETWORK_SUFFIX;
    ...
    public static final HttpUrl VERSION_URL = HttpUrl.parse("http://192.168.0.5:8019/www/newbull-bitcoin-wallet-version"
            + (NETWORK_PARAMETERS.getId().equals(NetworkParameters.ID_MAINNET) ? "" : "-test"));
    /** URL to fetch dynamic fees from. */
    public static final HttpUrl DYNAMIC_FEES_URL = HttpUrl.parse("http://192.168.0.5:8019/www/newbull-fees");

    /** MIME type used for transmitting single transactions. */
    public static final String MIMETYPE_TRANSACTION = "application/x-nbtx";

    /** MIME type used for transmitting wallet backups. */
    public static final String MIMETYPE_WALLET_BACKUP = "application/x-newbull-wallet-backup";

    /** Number of confirmations until a transaction is fully confirmed. */
    public static final int MAX_NUM_CONFIRMATIONS = 7;

    /** User-agent to use for network access. */
    public static final String USER_AGENT = "NewBull Wallet";
    ...
    public static final String DONATION_ADDRESS = NETWORK_PARAMETERS.getId().equals(NetworkParameters.ID_MAINNET)
            ? "NbUSBit9Q8mrDYPMwv6fW17rykThe3X735" : null;

    /** Recipient e-mail address for reports. */
    public static final String REPORT_EMAIL = "noreply@newbull.org";
    ...
    public static final String CHAR_BITCOIN = "NB";//char: \u20bf
    ...
    public static final String SOURCE_URL = "https://github.com/newbull/newbull-wallet";
    public static final String BINARY_URL = "https://newbull.org/";
