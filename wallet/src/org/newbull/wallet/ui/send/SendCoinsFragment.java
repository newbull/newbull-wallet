...
import org.newbull.wallet.addressbook.AddressBookDao;
...
import org.newbull.wallet.data.PaymentIntent.Standard;
import org.newbull.wallet.integration.android.NewBullIntegration;
...
import org.newbull.wallet.ui.AddressAndLabel;
import org.newbull.wallet.ui.CurrencyAmountView;
import org.newbull.wallet.ui.CurrencyCalculatorLink;
import org.newbull.wallet.ui.DialogBuilder;
import org.newbull.wallet.ui.InputParser.BinaryInputParser;
import org.newbull.wallet.ui.InputParser.StreamInputParser;
import org.newbull.wallet.ui.InputParser.StringInputParser;
import org.newbull.wallet.ui.ProgressDialogFragment;
...
import org.newbull.wallet.util.Nfc;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action))
                    && intentUri != null && "newbull".equals(scheme)) {
                ...
                initStateFromPaymentRequest(mimeType, ndefMessagePayload);
                    ...
                    && PaymentProtocol.MIMETYPE_PAYMENTREQUEST.equals(mimeType)) {
                final byte[] paymentRequest = NewBullIntegration.paymentRequestFromIntent(intent);
        ...
        new SendCoinsOfflineTask(wallet, backgroundHandler) {
            ...
            protected void onSuccess(final Transaction transaction) {
                ...
                if (callingActivity != null) {
                    ...
                    NewBullIntegration.transactionHashToResult(result, transaction.getTxId().toString());
                    if (viewModel.paymentIntent.standard == Standard.BIP70)
                        NewBullIntegration.paymentToResult(result, payment.toByteArray());
