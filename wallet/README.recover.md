...
Normally, this shouldn't be needed. It is much preferred to just use **Options > Safety > Restore wallet** from within the NewBull Wallet app if you can. This guide is only meant for rare cases:
...
You can also get a list of your private keys, e.g. to claim coins other than NewBull which may sit on the same keys. To dump the private keys use:
...
or [NewBull Core](https://bitcoincore.org/).
