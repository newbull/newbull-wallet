...
storage:
    ...
    Mainnet: /data/data/newbull.wallet/files/wallet-protobuf
    Testnet: /data/data/newbull.wallet_test/files/wallet-protobuf-testnet
...
Certain actions cause automatic rolling backups of your wallet to app-private storage:
    ...
    Mainnet: /data/data/newbull.wallet/files/key-backup-protobuf
    Testnet: /data/data/newbull.wallet_test/files/key-backup-protobuf-testnet
...
app-private storage:
    ...
    Mainnet: /data/data/newbull.wallet/files/fees.txt
    Testnet: /data/data/newbull.wallet_test/files/fees-testnet.txt
...
Wallet file for Testnet can be pulled from an (even un-rooted) device using:
    ...
    adb pull /data/data/newbull.wallet_test/files/wallet-protobuf-testnet
...
Finally, you can build NewBull Wallet and sign it with your development key. Again in your workspace,
use:
...
NewBull Wallet supports reading NewBull requests via NFC, either from a passive NFC tag or from
...
- The tag needs to contain a NewBull URI. You can construct one with the "Request coins" dialog,
...
- If you put your tag at a public place, don't forget to enable write protect. Otherwise, someone
  could overwrite the tag with his own NewBull address.


### BITCOINJ

NewBull Wallet uses [newbullj](https://github.com/newbull/newbullj) for NewBull specific logic.


### EXCHANGE RATES

NewBull Wallet reads this feed from "CoinGecko" for getting exchange rates:
...
When sweeping wallets, NewBull Wallet uses a set of Electrum servers to query for unspent transaction
